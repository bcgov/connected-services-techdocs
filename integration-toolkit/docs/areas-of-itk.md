...
## Put into practice
 ...
 Knowing what each area does is the first step. Here's how to actually start using ITK today.  See [Finding and using ITK](/docs/default/component/integration-toolkit-techdocs/finding-and-using-itk/). 
