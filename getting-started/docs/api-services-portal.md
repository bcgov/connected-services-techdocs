...
### Who should use API Services Portal?
...
### When should I use API Services Portal?
...
!!! Note
     If your team needs to transfer highly sensitive personal data between organizations with legal tracking, look at [Secure Data Exchange (SDX)](secure-data-exchange.md) as well.
...
- Check out full technical details on [API Program Services documentation](/docs/default/component/aps-infra-platform-docs/).
